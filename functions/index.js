...
exports.webhook = functions.https.onRequest((request, response) => {
    ...
    switch (request.body.result.action) {
        case "Enrollment":
            ...
            let name = request.body.result.parameters["given-name"];
            let age = request.body.result.parameters.age;
            let Class = request.body.result.parameters.Class;

            // Add a new document with a generated id.
            var addDoc = db.collection('enrollment').add({
                name: name,
                age: age,
                Class: Class
            }).then(ref => {
        ...
        case "getEnrollment":
            ...
            let enrollmentRef = db.collection('enrollment');
            let query = enrollmentRef.where('Class', '==', subject).get()
                .then(snapshot => {
        ...
        case "getMatriculation":
            ...
            let college = request.body.result.parameters.college;
            let data = request.body.result.parameters.date - period;

            query = enrollmentRef.where('Class', '==', subject).get()
                .then(snapshot => {
        ...
        case "getPopulation":
            ...
            let college1 = request.body.result.parameters.school1;
            let results = [];
...
exports.makeEntity = functions.https.onRequest((req, res) => {
